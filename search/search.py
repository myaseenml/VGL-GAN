...
def eval_mario(ind,visualize): # fitness function
    ...
    return completion_percentage  # fitness value #Can change
...
def run_trial(num_to_evaluate,algorithm_name,algorithm_config,elite_map_config,trial_name,model_path,visualize):
    ...
    if algorithm_name=="CMAES":
        ...
        population_size=algorithm_config["population_size"]
        algorithm_instance=RandomGenerator(num_to_evaluate,population_size,feature_map,trial_name,column_names,bc_names)
