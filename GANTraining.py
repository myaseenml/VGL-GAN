...
print(netG)
torchinfo.summary(netG, (32, 1, 1), batch_dim = 0, col_names = ("input_size", "output_size", "num_params", "kernel_size", "mult_adds"), verbose = 1)
...
print(netD)
torchinfo.summary(netD, (17, 64, 64), batch_dim = 0, col_names = ("input_size", "output_size", "num_params", "kernel_size", "mult_adds"), verbose = 1)
...
# setup optimizer
if opt.adam:
    optimizerD = optim.Adam(netD.parameters(), lr=opt.lrD, betas=(0.85, 0.99))
    optimizerG = optim.Adam(netG.parameters(), lr=opt.lrG, betas=(0.65, 0.999))
    print("Using ADAM")
else:
